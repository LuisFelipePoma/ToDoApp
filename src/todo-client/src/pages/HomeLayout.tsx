...
import IconSideBar from '../assets/IconSideBar'
          ...
          <section className='px-3 py-4 overflow-y-auto '>
            <ul className='space-y-2 font-medium'>
              <li>
                ...
                >
                  <svg
                    className='w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400-hover:text-gray-900 dark-hover:text-white'
                    aria-hidden='true'
              ...
              <li>
                ...
                >
                  <svg
                    className='flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400-hover:text-gray-900 dark-hover:text-white'
                    aria-hidden='true'
                    xmlns='http://www.w3.org/2000/svg'
                    fill='currentColor'
                    viewBox='0 0 18 18'
